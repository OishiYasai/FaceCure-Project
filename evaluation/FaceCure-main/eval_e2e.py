    ...
    def __init__(self, original_images, protect_images, cloak_frac=1.0, aligner=None):
        ...
        for cur_data_dir in select_data_dir:
            ...
            if args.robust:
                ...
                p1 = glob.glob(os.path.join(dir1 + cur_class + "/face/", "*cloaked.png"))
                p2 = glob.glob(os.path.join(dir2 + cur_class + "/face/", "*_attacked.png"))
                p3 = glob.glob(os.path.join(dir3 + cur_class + "/face/", "*cloaked.png"))
                print("Found {} {} {} cloaked images".format(len(p1), len(p2), len(p3)))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--protected-file-match', type=str,
                        help='pattern to match protected pictures', default='attacked.png')
    parser.add_argument('--verbose', action='store_true')
    parser.add_argument('--robust', action='store_true')
    parser.add_argument('--public-attack-dirs', nargs='+', default=['facescrub_fawkes_attack/download/', 'facescrub_lowkey_attack/download/', 'facescrub_fawkesv03_attack/download/'])
